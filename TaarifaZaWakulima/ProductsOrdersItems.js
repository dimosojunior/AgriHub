...
const ProductsOrdersItems = ({navigation, route}) => {
      ...
      style={globalStyles.OverdoseCartItemsContainer} >
        ...
        >
         ...
         >
           ...
           style={globalStyles.OverdoseItemNameCartItemsText}
         >
           Price per bag:  {formatToThreeDigits(item.product.FarmPricePerBag)}
          </Text>
...
<Pressable
        ...
        >
          <View style={{
            ...
            <Text style={{ marginTop: 7,color:"white", fontSize: 15 }}>Tsh. {formatToThreeDigits(total_price)}/=</Text>
          </View>
...
export default ProductsOrdersItems;
