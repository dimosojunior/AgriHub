...
export default function RegisterBuyer({ navigation }) {
...
const [showRegions, setShowRegions] = useState(false);
 ...
 if (!emailRegex.test(Email)) {
   ...
   axios.post(EndPoint + `/AddNewBuyersView/`, formData, {
        headers: {
        ...
        setPending(false);
        showAlertFunction("New Buyer is added successfull");
        //console.log("Well");
...
<LinearGradient colors={['#015d68', '#000']} style={globalStyles.container}>
  ...
  <View style={globalStyles.loaderOverlay}>
    <View style={globalStyles.loaderContent}>
      ...
      <Text style={globalStyles.loaderText}>Adding new buyer</Text>
