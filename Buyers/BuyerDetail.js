...
const BuyerDetail = ({navigation, route}) => {
...
const [KiasiChaRejeshoChaSiku, setKiasiChaRejeshoChaSiku] = useState(0);
 ...
 const handleDeletePost = async () => {
    ...
    try {
      await axios.delete(EndPoint + `/DeleteBuyersPostView/${postId}/delete/`, {
        headers: {
   ...
   <Pressable
      ...
      {((userData && userData.is_admin === true) || (userData && userData.username === Username))  && (
        ...
        // }}
          ...
          onPress={() => navigation.navigate("Update Buyer", 
            {
               postId,
                id,
                full_name,
