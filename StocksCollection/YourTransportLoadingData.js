...
const YourTransportLoadingData = ({ navigation, route }) => {
...
const getItems = (token) => {
  if (endReached) {
   ...
   const url = EndPoint + `/GetAllTransportLoadingForSpecificTransporterView/?BuyerUsername=${BuyerUsername}&BuyerRegNo=${BuyerRegNo}&id=${id}&page=${current_page}&page_size=500`
    // console.log(url);
    fetch(url, {
      method: 'GET',
      headers: {
...
> Transporter Data </Text>
 ...
 {setLoading===true?(<ActivityIndicator/>):(
  ...
  <Text style={globalStyles.noitemText}>There is no any data for this order
  </Text>
...
export default YourTransportLoadingData;
