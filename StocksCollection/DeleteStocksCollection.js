...
const DeleteStocksCollection = ({navigation, route}) => {
...
<View style={{
  ...
  {[
    ...
    { label: 'Crop Unit Price', value: CropUnitPrice },
    { label: 'Storage Charges PerUnit', value: StorageChargesPerUnit },
    { label: 'TotalPrice', value: TotalPriceForAllDebe },
    { label: 'Total Storage Charges', value: TotalStorageChargesForAllDebe },
...
export default DeleteStocksCollection;
