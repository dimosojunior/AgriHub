...
export default function RegisterStakeHolder({ navigation }) {
 ...
 if (!emailRegex.test(Email)) {
   ...
   // const date_of_birth = `${year}-${month.padStart(2, '0')}-${day.padStart(2, '0')}`;
    ...
    if (Department) {
        ...
        showAlertFunction('Please enter department in organization ');
        return;
    }
   ...
   axios.post(EndPoint + `/AddNewStakeHoldersView/`, formData, {
        headers: {
        ...
        setPending(false);
        showAlertFunction("New stakeholder is added successfull");
        //console.log("Well");
