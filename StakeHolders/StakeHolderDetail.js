...
const StakeHolderDetail = ({navigation, route}) => {
...
const [KiasiChaRejeshoChaSiku, setKiasiChaRejeshoChaSiku] = useState(0);
 ...
 const handleDeletePost = async () => {
    ...
    try {
      await axios.delete(EndPoint + `/DeleteStakeHoldersPostView/${postId}/delete/`, {
        headers: {
...
{((userData && userData.is_admin === true) || (userData && userData.username === Username))  && (
        ...
        // }}
          ...
          onPress={() => navigation.navigate("Update StakeHolder", 
            {
               postId,
                id,
               full_name,
